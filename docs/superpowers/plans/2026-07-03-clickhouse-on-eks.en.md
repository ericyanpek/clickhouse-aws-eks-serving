...
[中文](./2026-07-03-clickhouse-on-eks.md) · **English**
...
> `max_server_memory_usage_to_ram_ratio: 0.9`). The current sources of truth are the code,
> [`../../../README.md`](../../../README.md), and
> [`../../../README.en.md`](../../../README.en.md). The design spec is background context.
> Commands, versions, topology, scripts, and recovery behavior below are historical and may be
> obsolete. This file is intentionally not rewritten because it preserves the executed build history.
